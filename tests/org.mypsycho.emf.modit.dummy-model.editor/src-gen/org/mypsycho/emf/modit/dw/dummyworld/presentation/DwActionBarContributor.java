 ...
 */
package org.mypsycho.emf.modit.dw.dummyworld.presentation;
...
/**
 * This is the action bar contributor for the Dw model editor.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class DwActionBarContributor
	...
	protected IAction showPropertiesViewAction =
		new Action(DummyWorldEditorPlugin.INSTANCE.getString("_UI_ShowPropertiesView_menu_item")) //$NON-NLS-1$
		{
			@Override
			public void run() {
				try {
					...
					DummyWorldEditorPlugin.INSTANCE.log(exception);
				}
			}
		};
	...
	protected IAction refreshViewerAction =
		new Action(DummyWorldEditorPlugin.INSTANCE.getString("_UI_RefreshViewer_menu_item")) //$NON-NLS-1$
		{
			@Override
	...
	public void contributeToToolBar(IToolBarManager toolBarManager) {
		...
		toolBarManager.add(new Separator("dw-settings")); //$NON-NLS-1$
		toolBarManager.add(new Separator("dw-additions")); //$NON-NLS-1$
	}
	...
	public void contributeToMenu(IMenuManager menuManager) {
		...
		IMenuManager submenuManager = new MenuManager(DummyWorldEditorPlugin.INSTANCE.getString("_UI_DwEditor_menu"), "org.mypsycho.emf.modit.dw.dummyworldMenuID"); //$NON-NLS-1$ //$NON-NLS-2$
		...
		//
		createChildMenuManager = new MenuManager(DummyWorldEditorPlugin.INSTANCE.getString("_UI_CreateChild_menu_item")); //$NON-NLS-1$
		submenuManager.insertBefore("additions", createChildMenuManager); //$NON-NLS-1$

		// Prepare for CreateSibling item addition or removal.
		//
		createSiblingMenuManager = new MenuManager(DummyWorldEditorPlugin.INSTANCE.getString("_UI_CreateSibling_menu_item")); //$NON-NLS-1$
	...
	public void menuAboutToShow(IMenuManager menuManager) {
		...
		submenuManager = new MenuManager(DummyWorldEditorPlugin.INSTANCE.getString("_UI_CreateChild_menu_item")); //$NON-NLS-1$
		populateManager(submenuManager, createChildSubmenuActions, null);
		populateManager(submenuManager, createChildActions, null);
		menuManager.insertBefore("edit", submenuManager); //$NON-NLS-1$

		submenuManager = new MenuManager(DummyWorldEditorPlugin.INSTANCE.getString("_UI_CreateSibling_menu_item")); //$NON-NLS-1$
