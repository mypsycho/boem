...
/**
 * This is the item provider adapter for a {@link org.mypsycho.emf.modit.dw.dummyworld.Company} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class CompanyItemProvider extends ContactItemProvider {
	/**
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(DwPackage.Literals.COMPANY__EMPLOYEES);
			childrenFeatures.add(DwPackage.Literals.COMPANY__OFFERS);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(DwPackage.Literals.COMPANY__EMPLOYEES,
				 DwFactory.eINSTANCE.createJob()));

		newChildDescriptors.add
			(createChildParameter
				(DwPackage.Literals.COMPANY__OFFERS,
				 DwFactory.eINSTANCE.createProduct()));
