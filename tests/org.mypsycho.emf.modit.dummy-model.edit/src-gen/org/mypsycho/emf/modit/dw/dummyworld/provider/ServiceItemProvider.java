...
/**
 * This is the item provider adapter for a {@link org.mypsycho.emf.modit.dw.dummyworld.Service} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ServiceItemProvider extends OfferItemProvider {
	/**
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(DwPackage.Literals.SERVICE__ACTIVITIES);
		}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Service.class)) {
			case DwPackage.SERVICE__ACTIVITIES:
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(DwPackage.Literals.SERVICE__ACTIVITIES,
				 DwFactory.eINSTANCE.createActivity()));
	}
