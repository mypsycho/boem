 ...
 * </p>
 * <ul>
 *   <li>{@link fr.obeo.dsl.dart.dart.impl.ControllerImpl#getPublishAs <em>Publish As</em>}</li>
 *   <li>{@link fr.obeo.dsl.dart.dart.impl.ControllerImpl#getSelector <em>Selector</em>}</li>
 * </ul>
 *
 * @generated
 */
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
		if (baseClass == Decorator.class) {
			switch (derivedFeatureID) {
				case DartPackage.CONTROLLER__SELECTOR: return DartPackage.DECORATOR__SELECTOR;
				default: return -1;
			}
		}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		if (baseClass == Decorator.class) {
			switch (baseFeatureID) {
				case DartPackage.DECORATOR__SELECTOR: return DartPackage.CONTROLLER__SELECTOR;
				default: return -1;
			}
		}
