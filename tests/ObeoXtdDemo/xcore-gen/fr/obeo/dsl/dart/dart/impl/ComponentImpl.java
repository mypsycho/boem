 ...
 * </p>
 * <ul>
 *   <li>{@link fr.obeo.dsl.dart.dart.impl.ComponentImpl#getPublishAs <em>Publish As</em>}</li>
 *   <li>{@link fr.obeo.dsl.dart.dart.impl.ComponentImpl#getSelector <em>Selector</em>}</li>
 *   <li>{@link fr.obeo.dsl.dart.dart.impl.ComponentImpl#getStylesheet <em>Stylesheet</em>}</li>
 *   <li>{@link fr.obeo.dsl.dart.dart.impl.ComponentImpl#getTemplate <em>Template</em>}</li>
 * </ul>
 *
 * @generated
 */
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
		if (baseClass == Decorator.class) {
			switch (derivedFeatureID) {
				case DartPackage.COMPONENT__SELECTOR: return DartPackage.DECORATOR__SELECTOR;
				default: return -1;
			}
		}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		if (baseClass == Decorator.class) {
			switch (baseFeatureID) {
				case DartPackage.DECORATOR__SELECTOR: return DartPackage.COMPONENT__SELECTOR;
				default: return -1;
			}
		}
