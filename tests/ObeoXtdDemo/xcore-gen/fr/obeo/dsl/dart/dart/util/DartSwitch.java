...
public class DartSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case DartPackage.ASSET: {
				...
				if (result == null) result = caseNamed(asset);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			...
			case DartPackage.FOLDER: {
				...
				if (result == null) result = caseNamed(folder);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case DartPackage.PACKAGE: {
				fr.obeo.dsl.dart.dart.Package package_ = (fr.obeo.dsl.dart.dart.Package)theEObject;
			...
			case DartPackage.DART_RESOURCE: {
				...
				if (result == null) result = caseNamed(dartResource);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			...
			case DartPackage.LIBRARY: {
				...
				if (result == null) result = caseNamed(library);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case DartPackage.PART: {
				...
				if (result == null) result = caseNamed(part);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			...
			case DartPackage.METADATA: {
				...
				if (result == null) result = caseNamed(metadata);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case DartPackage.CLASS: {
				fr.obeo.dsl.dart.dart.Class class_ = (fr.obeo.dsl.dart.dart.Class)theEObject;
			...
			case DartPackage.VARIABLE: {
				...
				if (result == null) result = caseTyped(variable);
			...
			case DartPackage.FUNCTION: {
				...
				if (result == null) result = caseParametrized(function);
				if (result == null) result = caseTyped(function);
				if (result == null) result = caseNamed(function);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case DartPackage.PARAMETRIZED: {
				Parametrized parametrized = (Parametrized)theEObject;
				T result = caseParametrized(parametrized);
				if (result == null) result = caseTyped(parametrized);
				if (result == null) result = caseNamed(parametrized);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			...
			case DartPackage.TYPEDEF: {
				...
				if (result == null) result = caseParametrized(typedef);
				if (result == null) result = caseTyped(typedef);
				if (result == null) result = caseNamed(typedef);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case DartPackage.HTML: {
				...
				if (result == null) result = caseNamed(html);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case DartPackage.STYLESHEET: {
				...
				if (result == null) result = caseNamed(stylesheet);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case DartPackage.MODULE: {
				fr.obeo.dsl.dart.dart.Module module = (fr.obeo.dsl.dart.dart.Module)theEObject;
			...
			case DartPackage.ANGULAR_TYPE: {
				...
				if (result == null) result = caseClass(angularType);
				if (result == null) result = caseClassifier(angularType);
				if (result == null) result = caseType(angularType);
				if (result == null) result = casePart(angularType);
				if (result == null) result = caseDartResource(angularType);
				if (result == null) result = caseAsset(angularType);
				if (result == null) result = caseNamed(angularType);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case DartPackage.PUBLISHED: {
				Published published = (Published)theEObject;
				T result = casePublished(published);
				if (result == null) result = caseAngularType(published);
				if (result == null) result = caseClass(published);
				if (result == null) result = caseClassifier(published);
				if (result == null) result = caseType(published);
				if (result == null) result = casePart(published);
				if (result == null) result = caseDartResource(published);
				if (result == null) result = caseAsset(published);
				if (result == null) result = caseNamed(published);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case DartPackage.DECORATOR: {
				...
				if (result == null) result = caseNamed(decorator);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case DartPackage.CONTROLLER: {
				...
				if (result == null) result = casePublished(controller);
				if (result == null) result = caseDecorator(controller);
				...
				if (result == null) result = caseNamed(controller);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case DartPackage.COMPONENT: {
				...
				if (result == null) result = casePublished(component);
				if (result == null) result = caseDecorator(component);
			...
			case DartPackage.FORMATTER: {
				...
				if (result == null) result = caseNamed(formatter);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case DartPackage.ROUTE: {
				...
				if (result == null) result = caseNamed(route);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case DartPackage.NAMED: {
				Named named = (Named)theEObject;
				T result = caseNamed(named);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case DartPackage.TYPED: {
	 ...
	 * @generated
	 */
	public T casePackage(fr.obeo.dsl.dart.dart.Package object) {
		return null;
	}
	 ...
	 * @generated
	 */
	public T caseClass(fr.obeo.dsl.dart.dart.Class object) {
		return null;
	}
	 ...
	 * @generated
	 */
	public T caseModule(fr.obeo.dsl.dart.dart.Module object) {
		return null;
	}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Published</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Published</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T casePublished(Published object) {
		return null;
	}
