...
public interface DartPackage extends EPackage {
	 ...
	 * @ordered
	 */
	int ASSET_OPERATION_COUNT = NAMED_OPERATION_COUNT + 0;
	 ...
	 * @ordered
	 */
	int CONTAINER_OPERATION_COUNT = NAMED_OPERATION_COUNT + 0;
	 ...
	 * @ordered
	 */
	int VARIABLE_OPERATION_COUNT = TYPED_OPERATION_COUNT + 0;
	 ...
	 * @ordered
	 */
	int FUNCTION__NAME = TYPED__NAME;
	 ...
	 * @ordered
	 */
	int FUNCTION__TYPE = TYPED__TYPE;
	 ...
	 * @ordered
	 */
	int FUNCTION__DOCUMENTATION = TYPED_FEATURE_COUNT + 0;
	 ...
	 * @ordered
	 */
	int FUNCTION__ABSTRACT = TYPED_FEATURE_COUNT + 1;
	 ...
	 * @ordered
	 */
	int FUNCTION__STATIC = TYPED_FEATURE_COUNT + 2;
	 ...
	 * @ordered
	 */
	int FUNCTION__BODY = TYPED_FEATURE_COUNT + 3;
	 ...
	 * @ordered
	 */
	int FUNCTION__PARAMETERS = TYPED_FEATURE_COUNT + 4;
	 ...
	 * @ordered
	 */
	int FUNCTION__METADATA = TYPED_FEATURE_COUNT + 5;
	 ...
	 * @ordered
	 */
	int FUNCTION_FEATURE_COUNT = TYPED_FEATURE_COUNT + 6;
	 ...
	 * @ordered
	 */
	int FUNCTION_OPERATION_COUNT = TYPED_OPERATION_COUNT + 0;
	 ...
	 * @ordered
	 */
	int TYPEDEF__DOCUMENTATION = TYPE_FEATURE_COUNT + 2;
	...
	/**
	 * The meta object id for the '{@link fr.obeo.dsl.dart.dart.impl.DecoratorImpl <em>Decorator</em>}' class.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see fr.obeo.dsl.dart.dart.impl.DecoratorImpl
	 ...
	 * @ordered
	 */
	int ROUTE_OPERATION_COUNT = NAMED_OPERATION_COUNT + 0;
	...
	/**
	 * Returns the meta object for the containment reference list '{@link fr.obeo.dsl.dart.dart.Function#getParameters <em>Parameters</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the containment reference list '<em>Parameters</em>'.
	 * @see fr.obeo.dsl.dart.dart.Function#getParameters()
	 * @see #getFunction()
	 * @generated
	 */
	...
	/**
	 * Returns the meta object for the containment reference list '{@link fr.obeo.dsl.dart.dart.Typedef#getParameters <em>Parameters</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the containment reference list '<em>Parameters</em>'.
	 * @see fr.obeo.dsl.dart.dart.Typedef#getParameters()
	 * @see #getTypedef()
	 * @generated
	 */
	...
	/**
	 * Returns the meta object for the attribute '{@link fr.obeo.dsl.dart.dart.Controller#getPublishAs <em>Publish As</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the attribute '<em>Publish As</em>'.
	 * @see fr.obeo.dsl.dart.dart.Controller#getPublishAs()
	 * @see #getController()
	 * @generated
	 */
	...
	/**
	 * Returns the meta object for the attribute '{@link fr.obeo.dsl.dart.dart.Controller#getSelector <em>Selector</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the attribute '<em>Selector</em>'.
	 * @see fr.obeo.dsl.dart.dart.Controller#getSelector()
	 * @see #getController()
	 * @generated
	 */
	...
	/**
	 * Returns the meta object for the attribute '{@link fr.obeo.dsl.dart.dart.Component#getPublishAs <em>Publish As</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the attribute '<em>Publish As</em>'.
	 * @see fr.obeo.dsl.dart.dart.Component#getPublishAs()
	 * @see #getComponent()
	 * @generated
	 */
	...
	/**
	 * Returns the meta object for the attribute '{@link fr.obeo.dsl.dart.dart.Component#getSelector <em>Selector</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the attribute '<em>Selector</em>'.
	 * @see fr.obeo.dsl.dart.dart.Component#getSelector()
	 * @see #getComponent()
	 * @generated
	 */
	...
	interface Literals {
		...
		/**
		 * The meta object literal for the '{@link fr.obeo.dsl.dart.dart.impl.DecoratorImpl <em>Decorator</em>}' class.
		 * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
		 * @see fr.obeo.dsl.dart.dart.impl.DecoratorImpl
		 * @see fr.obeo.dsl.dart.dart.impl.DartPackageImpl#getDecorator()
