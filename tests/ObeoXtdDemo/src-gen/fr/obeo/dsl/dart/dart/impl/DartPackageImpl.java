...
public class DartPackageImpl extends EPackageImpl implements DartPackage {
	...
	public void initializePackageContents() {
		...
		functionEClass.getESuperTypes().add(this.getTyped());
		parameterEClass.getESuperTypes().add(this.getTyped());
		typedefEClass.getESuperTypes().add(this.getType());
		typedefEClass.getESuperTypes().add(this.getTyped());
		...
		initEAttribute(getPackage_License(), ecorePackage.getEString(), "license", null, 0, 1, fr.obeo.dsl.dart.dart.Package.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getClass_Abstract(), ecorePackage.getEBoolean(), "abstract", null, 0, 1, fr.obeo.dsl.dart.dart.Class.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
