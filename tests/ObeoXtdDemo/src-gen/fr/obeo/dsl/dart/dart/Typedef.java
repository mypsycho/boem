 ...
 *   <li>{@link fr.obeo.dsl.dart.dart.Typedef#getParameters <em>Parameters</em>}</li>
 ...
 * @generated
 */
public interface Typedef extends Type, Typed {
	/**
	 ...
	 * @see fr.obeo.dsl.dart.dart.DartPackage#getTypedef_Parameters()
