 ...
 * </p>
 * <ul>
 *   <li>{@link org.mypsycho.emf.modit.dw.dummyworld.impl.PurchaseImpl#getParent <em>Parent</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class PurchaseImpl extends MinimalEObjectImpl.Container implements Purchase {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	...
	protected EClass eStaticClass() {
		return DwPackage.Literals.PURCHASE;
	}
	...
	public Contact getParent() {
		if (eContainerFeatureID() != DwPackage.PURCHASE__PARENT) return null;
	...
	public NotificationChain basicSetParent(Contact newParent, NotificationChain msgs) {
		msgs = eBasicSetContainer((InternalEObject)newParent, DwPackage.PURCHASE__PARENT, msgs);
		return msgs;
	}
	...
	public void setParent(Contact newParent) {
		if (newParent != eInternalContainer() || (eContainerFeatureID() != DwPackage.PURCHASE__PARENT && newParent != null)) {
			...
			eNotify(new ENotificationImpl(this, Notification.SET, DwPackage.PURCHASE__PARENT, newParent, newParent));
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case DwPackage.PURCHASE__PARENT:
				if (eInternalContainer() != null)
					msgs = eBasicRemoveFromContainer(msgs);
